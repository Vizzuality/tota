...
export const MultiSelect: FC<SelectProps> = ({
  ...
  const { getDropdownProps, addSelectedItem, removeSelectedItem, setSelectedItems, selectedItems, reset } =
                ...
                <li
                  className={cx({
                    ...
                    [THEME[theme].item.highlighted]:
                      (highlightedIndex === index && !option.disabled) || isSelected(option, selectedItems),
                  })}
                  key={`${option.value}`}
