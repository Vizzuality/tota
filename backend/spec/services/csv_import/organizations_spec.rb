...
describe CSVImport::Organizations do
  describe 'errors' do
    it 'should return error if required column not provided' do
      csv_content = <<-CSV
        Company Id,Name of Business,website,Tourism Region,Tourism Sub-Region,Business Type,Business Sub-Type,Indigenous Tourism,Biosphere program member,Latitude,Longitude
    ...
    it 'should return error for a row if data invalid' do
      ...
      csv_content = <<-CSV
        ...
        324323,Planet Bee Honey Farm & Meadery,http://example.com,Thompson Okanagan,North Okanagan,Activity / Attraction,FALSE,FALSE,50.2632292,-119.3063629
        121222,,http://example2.com,Thompson Okanagan,South Okanagan,Accommodation,Bed & Breakfast,TRUE,TRUE,49.0463827,-119.4914925
      CSV
