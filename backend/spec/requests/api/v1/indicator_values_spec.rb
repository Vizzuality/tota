...
RSpec.describe 'API V1 Indicator Values', type: :request do
  before_all do
    ...
    create(:organization, business_type_1: bt1, region: @r1, biosphere_program_member: true)
    create(:organization, business_type_1: bt1, region: @r1)
    create(:organization, business_type_1: bt2, region: @r1, biosphere_program_member: true)
    create(:organization, business_type_1: bt3, region: @r1)
    create(:organization, business_type_1: bt3, region: @r1, biosphere_program_member: true)
    ...
    create(:organization, business_type_1: bt4, region: @r2)
